...
//     <div
//         className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 h-full"
//         style={{
    ...
    <div className="relative flex flex-col border shadow-sm rounded-xl overflow-hidden h-full dark:border-neutral-700 dark:shadow-neutral-700/70">
        ...
        <div className="relative z-10 flex flex-col h-full">
            ...
            >
                <div className="flex justify-center gap-x-2 w-full">
                    <p>Visit LinkedIn</p>
                    <img className="w-4 h-4" src={LinkedInTwo} alt="LinkedIn icon" />
                </div>
            </a>
        </div>
    </div>
